    ...
    .menu
      el-menu(
        ...
        el-submenu(index="0")
          template(slot="title")
            .el-icon-message
            span(slot="title") 我的订单

          el-menu-item(index="0-0") 全部
            span.summary
          el-menu-item(index="0-1") 待付款
            span.summary {{summary.created || 0}}
          el-menu-item(index="0-2") 待发货
            span.summary {{summary.paid || 0}}
          el-menu-item(index="0-3") 待收货
            span.summary {{summary.sent || 0}}
            span.red-point(v-if="untouch.order")
          el-menu-item(index="0-4") 已签收
            span.summary {{summary.received || 0}}
          el-menu-item(index="0-5") 其他
            span.summary {{summary.closed || 0}}
</template>
