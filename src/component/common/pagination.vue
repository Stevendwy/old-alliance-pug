...
.pagination
    button.pagination-direction(
        ...
        @click="limitClick('first')"
    )   |<<
    button.pagination-direction(
        :class="{'pagination-direction-death': isFirst}",
        @click="directionClick('previous')"
    )   <
    ul.pagination-pages
      li.pagination-page-ctrl(
        ...
        @click="pageCtrlClick(shouldShowCount(item) - 1)"
      ) {{shouldShowCount(item)}}
    
    button.pagination-direction(
        :class="{'pagination-direction-death': isLast}",
        @click="directionClick('next')"
    )   >
    button.pagination-direction(
        :class="{'pagination-direction-death': isLast}",
        @click="limitClick('last')"
    )   >>|
</template>
