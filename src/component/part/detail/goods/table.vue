<template lang="pug">
  .table
    .t-header
      .th-item(v-for="title in headerTitles", :key="title") {{title}}
        
    .t-content
      .tc-row(v-for="(item, index) in contentList", :key="index + 'item'")
        ...
        .tcr-item(:class="item.in_spcarts ? 'sale-shopping-cart-selected' : 'sale-shopping-cart'", @click="cartClick(item)")
